...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    public class KeyboardValueKey : MonoBehaviour
    {
        ...
        /// </summary>
        private PressableButton m_Button;
        ...
        private void Awake()
        {
            m_Button = GetComponent<PressableButton>();
        }
        ...
        private void Start()
        {
            ...
            m_Button.OnClicked.RemoveAllListeners();
            m_Button.OnClicked.AddListener(FireAppendValue);
